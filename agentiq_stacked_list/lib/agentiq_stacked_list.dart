...
class AgentiqStackedList extends StatelessWidget {
  const AgentiqStackedList({
    super.key,
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: StackedCardCarousel(
        initialOffset: itemHeight * 0.1,
        spaceBetweenItems: itemHeight * 0.8,
        items: children,
      ),
    );
  }
          ...
          switch (widget._type) {
            case StackedCardCarouselType.fadeOutStack:
              ...
              if (item.key - _pageValue < 0) {
                ...
                scale = factor < 0.0 ? 0.0 : pow(factor, 0.5).toDouble();
              }
